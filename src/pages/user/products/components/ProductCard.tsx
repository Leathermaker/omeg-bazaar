...
const ProductCard = ({ product }: { product: Product }) => {
  ...
  return (
    <div
      ...
      className="bg-white p-3  rounded-xl flex flex-col w-[14rem] sm:w-[34vw] md:w-[14rem] lg:h-[18rem] lg:w-[15rem] shadow-md hover:shadow-2xl transition-shadow duration-300 "
    >
