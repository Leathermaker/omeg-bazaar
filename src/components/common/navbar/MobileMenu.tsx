      ...
      {isCardVisible && (
        <>
          ...
          <motion.div
            ...
            animate={{ scale: 1, x: 0, y: 0, height: "auto", width: "80vw", transition: { duration: 0.3 } }}
            exit={{ scale: 0.9, x: 50, y: -50, height: 0, width: 0, transition: { duration: 0.3 } }}
            className="bg-primary text-white p-6 rounded-4xl fixed top-16 right-5 z-[110] shadow-lg border-white/20 border-[1px] "
          >
            <motion.button exit={{ height: 0, width: 0 }} onClick={() => setIsCardVisible(false)}
            ...
            <div className="mt-10" onClick={handleClick}>
              ...
              <div className="flex justify-between items-center mt-8">
                <div className="flex gap-2">
                  <motion.button
                    animate={{ scale: 1, x: 0, y: 0, height: "28px", width: "28px",
                      transition: { duration: 0.3 }
                    }}
                    exit={{ height: 0, width: 0, opacity: 0 , scale: 0, 
